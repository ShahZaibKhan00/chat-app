<div>
    ...
    <div class="chatlist">
        ...
        @forelse ($conversations as $conversation)
            <div class="border-2 bg-gray-300 rounded-lg px-3 flex items-center m-1" wire:click="$emit('chatSelected', {{ $conversation }}, {{ $this->getUserChatInstance($conversation, $name='name') }})">
                ...
                <div class="both-div px-4">
                    ...
                    <div class="flex">
                        ...
                        {{-- Count of message --}}
                        <span class="font-bold mx-3 ">{{ __("6") }}</span>
                    </div>
                </div>
            </div>
        @empty
